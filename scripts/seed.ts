    ...
    const sampleBookings = [
      {
        ...
        packageId: createdPackages[0]._id, // Wedding Silver
        customerName: 'Sarah Johnson',
        customerEmail: 'sarah@example.com',
        customerPhone: '555-0101',
        bookingDate: new Date(Date.now() + 30 * 24 * 60 * 60 * 1000), // 30 days from now
        status: 'confirmed',
        notes: 'Looking forward to our wedding!',
      },
      {
        userId: createdUsers[2]._id,
        packageId: createdPackages[3]._id, // Birthday Gold
      ...
      },
      {
        ...
        packageId: createdPackages[7]._id, // Photography Gold
