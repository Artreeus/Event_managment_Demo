        ...
        <div className="container mx-auto px-4">
          ...
          <div className="flex flex-col md:flex-row md:items-end justify-between gap-6">
            <div>
              ...
              <p className="text-slate-300 text-lg">Explore our professional event service categories</p>
            </div>
        ...
        <div className="container mx-auto px-4">
          {isLoading ? (
            <div className="flex flex-col items-center justify-center py-24 gap-3">
              ...
              <p className="text-slate-500 dark:text-gray-400 text-sm">Loading categories...</p>
            </div>
          ) : error ? (
            ...
            <div className="flex flex-col items-center justify-center py-24 gap-4">
              <div className="w-16 h-16 bg-slate-200 dark:bg-gray-800 rounded-2xl flex items-center justify-center">
                <Grid3X3 className="w-8 h-8 text-slate-400 dark:text-gray-500" />
              </div>
              ...
              {search && <Button variant="outline" size="sm" onClick={() => setSearch('')} className="dark:border-gray-700 dark:text-gray-300">Clear Search</Button>}
            </div>
          ) : (
            <>
                    ...
                    <div className="bg-white dark:bg-gray-800 rounded-2xl border border-slate-200 dark:border-gray-700 overflow-hidden hover:shadow-xl hover:shadow-slate-200/80 dark:hover:shadow-black/30 hover:-translate-y-1 transition-all duration-300 h-full flex flex-col">
                      ...
                      <div className="p-6 flex flex-col flex-1">
                        ...
                        {category.description && (
                          <p className="text-slate-500 dark:text-gray-400 text-sm leading-relaxed mb-5 flex-1 line-clamp-2">{category.description}</p>
                        )}
